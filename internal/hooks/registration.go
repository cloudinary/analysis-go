...
func initHooks(h *Hooks) {
	cldHook := &CloudinaryHook{}

	h.registerSDKInitHook(cldHook)
	h.registerBeforeRequestHook(cldHook)
	// h.registerAfterErrorHook(cldHook)
	// h.registerAfterSuccessHook(cldHook)
}
